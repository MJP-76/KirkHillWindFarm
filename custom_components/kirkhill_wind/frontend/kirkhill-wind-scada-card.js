...
_buildHeaderChips(layout) {
  ...
  _styles() {
    return `
      ...
      .grid-label { fill: var(--secondary-text-color, #475569); font: 16px var(--font-family, sans-serif); }
      ...
      .grid-unit { fill: var(--disabled-text-color, #64748b); font: 16px var(--font-family, sans-serif); }
