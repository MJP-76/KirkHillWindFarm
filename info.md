...
- **Auto-generated Lovelace dashboard** — created automatically during setup with SCADA as the only tab:
...
- **Overview tab removed** — dashboard is now the SCADA tab only (History removed in v4.8.77, Finances removed in v4.8.79, Turbines removed in v4.8.80)
