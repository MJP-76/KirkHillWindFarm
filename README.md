...
```
Kirk Hill Wind Farm — Technical Reference

Onshore wind farm near Kirkoswald, South Ayrshire, Scotland.
Coordinates: 55.3064, -4.7399.

Turbines

- 8 x Enercon E92/2350 wind energy converters
...
- Underground cabling between turbines and substation, and to the point of
  connection
- Grid connection to the Scottish Power (SP Energy Networks) network via a new
  substation
- Connection route: ~6 km total, comprising overhead line (~5 km, 70 poles) and
  ~1 km underground cable
