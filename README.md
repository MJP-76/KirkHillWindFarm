...
Managed by Ripple Energy, the project was funded using a 32 million pound
co-operative investment model. Over 5,600 households and small businesses across
Scotland, England, and Wales bought shares in the wind farm. Instead of a
traditional corporate utility pocketing the profits, the green electricity
generated by the turbines is stabilizing or actively reducing the owners' home
energy bills. Members purchase "watts" of the farm equivalent to their annual
household usage to offset up to 100% of their electricity footprint.
```
