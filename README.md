...
- Compact Quick actions reload control at the top of the dashboard that calls integration reload
...
- A compact top-level **Quick actions** reload control that calls `kirkhill_wind.reload_integration`
